  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center text-center px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          Explore os Melhores <span className="text-amber-400">ImÃ³veis</span> do HUBIMOB
        </h1>
        ...
        >
          IA que entende seu perfil, recomenda imÃ³veis ideais e organiza tudo para que vocÃª
          encontre o lar perfeito com facilidade e seguranÃ§a.
        </p>
