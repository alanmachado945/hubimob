...
const benefits = [
  ...
  'IA qualifica compradores automaticamente',
  'Acesso à rede premium de corretores',
  'Proteção jurídica em todas as etapas',
  'Suporte dedicado durante todo o processo'
];

export default function ProprietariosCTA() {
  return (
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
          ...
          <div className="relative z-10 p-12 md:p-16 text-center">
            ...
            <div className="inline-block px-4 py-2 rounded-full bg-amber-500/20 border border-amber-500/40 backdrop-blur-sm mb-8">
              <span className="text-sm font-bold text-amber-400" style={{ fontFamily: 'Montserrat, sans-serif' }}>
                COMECE AGORA — GRATUITO E SEM COMPROMISSO
              </span>
            </div>
            ...
            >
              Pronto Para Vender Seu Imóvel com <span className="text-amber-400">Inteligência</span>?
            </h2>
            ...
            >
              Junte-se aos milhares de proprietários que já venderam mais rápido e com mais segurança usando o HUBIMOB.
            </p>
            ...
            {/* CTA Button */}
            <button 
              className="group relative inline-flex items-center justify-center px-12 py-6 text-xl font-bold text-black bg-gradient-to-r from-amber-400 via-yellow-500 to-amber-600 rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-amber-500/50 mb-8"
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
            ...
            <p 
              ...
              style={{ fontFamily: 'Montserrat, sans-serif' }}
            >
              Sem taxas ocultas • Processo 100% transparente • Proteção jurídica completa
            </p>
          </div>
        ...
        <div className="mt-12 text-center">
          <p 
            ...
            style={{ fontFamily: 'Montserrat, sans-serif' }}
          >
            HUBIMOB • Plataforma Inteligente Para Proprietários • 2025
          </p>
        </div>
      </div>
    </section>
