...
export default function WhatsAppButton() {
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: "var(--brand-gold)", // dourado metálico
    ...
    >
      <svg
        ...
        fill="currentColor"
        style={{ color: "var(--brand-white)" }} // branco quente
        viewBox="0 0 24 24"
      >
      ...
      {/* Tooltip */}
      <div
        className="absolute right-full mr-3 px-4 py-2 text-sm font-medium rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-xl pointer-events-none"
        style={{
          backgroundColor: "var(--brand-dark)", // preto azul-grafite
          color: "var(--brand-gray)",           // cinza neutro
          border: "1px solid rgba(var(--brand-gold-rgb), 0.25)" // dourado 25%
        }}
      >
