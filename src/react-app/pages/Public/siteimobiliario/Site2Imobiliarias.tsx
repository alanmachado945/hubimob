    ...
    <div className="min-h-screen bg-brand-black">
      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-5 max-w-container mx-auto">
          <h1 className="font-display text-5xl md:text-6xl font-bold text-gradient-gold drop-shadow-lg">
            CresÃ§a com Tecnologia e InteligÃªncia
          </h1>

          <p className="text-xl text-brand-white/80 max-w-2xl mt-6">
            A HUBIMOB conecta imobiliÃ¡rias a uma rede inteligente, oferecendo IA,
            curadoria de leads e ferramentas avanÃ§adas para aumentar vendas e eficiÃªncia.
          </p>
      ...
      <section className="max-w-container mx-auto px-5 py-20">
        <h2 className="font-display text-4xl md:text-5xl font-bold text-gradient-gold text-center mb-12">
          Por que se tornar uma imobiliÃ¡ria parceira?
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="text-center glass-effect rounded-2xl p-8 hover:scale-105 transition-all duration-300">
            <h3 className="font-display text-2xl font-semibold text-brand-gold mb-4">
              Mais visibilidade, menos esforÃ§o
            </h3>
            <p className="text-brand-white/70 leading-relaxed">
              Seu portfÃ³lio ganha destaque na vitrine premium, atingindo compradores ideais.
            </p>
          </div>

          <div className="text-center glass-effect rounded-2xl p-8 hover:scale-105 transition-all duration-300">
            <h3 className="font-display text-2xl font-semibold text-brand-gold mb-4">
              Tecnologia sem complicaÃ§Ã£o
            </h3>
            <p className="text-brand-white/70 leading-relaxed">
              Dashboard intuitivo e automaÃ§Ãµes para facilitar sua rotina e acelerar resultados.
            </p>
          </div>
        ...
        <div className="max-w-container mx-auto px-5">
          ...
          <div className="grid md:grid-cols-4 gap-12 text-center">
            ...
            <div className="glass-effect rounded-2xl p-8 hover:scale-105 transition-all duration-300">
              ...
              <h3 className="font-display text-xl font-semibold text-brand-white mb-3">ConexÃ£o</h3>
              <p className="text-brand-white/70">
                Sua imobiliÃ¡ria entra na rede HUBIMOB com acesso total ao painel.
              </p>
            </div>

            <div className="glass-effect rounded-2xl p-8 hover:scale-105 transition-all duration-300">
              <div className="text-brand-gold text-6xl font-display font-bold mb-4">2</div>
              <h3 className="font-display text-xl font-semibold text-brand-white mb-3">IntegraÃ§Ã£o</h3>
              <p className="text-brand-white/70">
                Seus imÃ³veis sÃ£o conectados e otimizados com nossa curadoria premium.
              </p>
            </div>

            <div className="glass-effect rounded-2xl p-8 hover:scale-105 transition-all duration-300">
              <div className="text-brand-gold text-6xl font-display font-bold mb-4">3</div>
              <h3 className="font-display text-xl font-semibold text-brand-white mb-3">DistribuiÃ§Ã£o Inteligente</h3>
              <p className="text-brand-white/70">
                IA direciona seus imÃ³veis para compradores com maior probabilidade de compra.
              </p>
            </div>
            ...
            <div className="glass-effect rounded-2xl p-8 hover:scale-105 transition-all duration-300">
              ...
              <p className="text-brand-white/70">
                Mais retenÃ§Ã£o, mais vendas e processos muito mais rÃ¡pidos.
              </p>
            </div>
      ...
      <section className="max-w-container mx-auto px-5 py-20">
        <h2 className="font-display text-4xl md:text-5xl font-bold text-gradient-gold text-center mb-12">
          Diferenciais para ImobiliÃ¡rias Parceiras
        </h2>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="glass-effect p-8 rounded-2xl hover:shadow-2xl hover:shadow-brand-gold/20 transition-all duration-300 hover:scale-105">
            <h3 className="font-display text-2xl text-brand-gold font-semibold mb-4">
              IA que acelera negÃ³cios
            </h3>
            <p className="text-brand-white/70 leading-relaxed">
              PrevisÃ£o de intenÃ§Ã£o, precificaÃ§Ã£o assistida e matching inteligente.
            </p>
          </div>

          <div className="glass-effect p-8 rounded-2xl hover:shadow-2xl hover:shadow-brand-gold/20 transition-all duration-300 hover:scale-105">
            <h3 className="font-display text-2xl text-brand-gold font-semibold mb-4">
              Zero esforÃ§o operacional
            </h3>
            <p className="text-brand-white/70 leading-relaxed">
              A HUBIMOB cuida da prospecÃ§Ã£o e entrega oportunidades quentes direto no painel.
            </p>
          </div>
          ...
          <div className="glass-effect p-8 rounded-2xl hover:shadow-2xl hover:shadow-brand-gold/20 transition-all duration-300 hover:scale-105">
            ...
            <p className="text-brand-white/70 leading-relaxed">
              Ganhe escala conectando-se Ã  rede inteligentes de corretores + proprietÃ¡rios + compradores.
            </p>
          </div>
      ...
      <section className="text-center py-20 bg-gradient-to-b from-brand-black to-brand-graphite">
        <div className="max-w-container mx-auto px-5">
          ...
          Sua imobiliÃ¡ria pronta para o futuro
        </h2>
        <p className="text-brand-white/80 max-w-2xl mx-auto mt-4 text-lg">
          Tecnologia, performance e inteligÃªncia para impulsionar suas vendas como nunca antes.
        </p>
